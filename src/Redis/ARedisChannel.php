...
class ARedisChannel extends ARedisIterableEntity {
	...
	public function subscribe() {
		...
		$this->getClient()->subscribe(array($this->name),array($this,"receiveMessage"));
		return $this;
	}
	/**
	...
	public function unsubscribe() {
		...
		$this->getClient()->unsubscribe(array($this->name));
		return $this;
	}
	...
	public function publish($message) {
		...
		$this->_data[] = $message;
		return $this->getClient()->publish($this->name,$message);
	}
	/**
